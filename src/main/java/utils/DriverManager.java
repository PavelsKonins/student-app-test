...
public class DriverManager {
    ...
    private static RemoteWebDriver configureRemote() {
        URL url = null;
        try {
            url = new URL("https://oauth-onetwolv-f81f7:5829a63d-243b-486b-bdb8-96b68c837633@ondemand.us-west-1.saucelabs.com:443/wd/hub");
    ...
    private static MutableCapabilities configureCapabilities() {
        ...
        sauceOptions.setCapability("username", "oauth-onetwolv-f81f7");
        sauceOptions.setCapability("access_key", "5829a63d-243b-486b-bdb8-96b68c837633");
